...
const AIRPORT_COORDS = {
  ...
  'SDU':[-22.9106,-43.1631],   // Rio de Janeiro Santos Dumont
  'GRU':[-23.4356,-46.4731],   // São Paulo Guarulhos
  'SYD':[-33.9461,151.1772],
  'AKL':[-37.0082,174.7917],   // Auckland (Rocket Lab)
  'WLG':[-41.3272,174.8051],   // Wellington NZ
  'CHC':[-43.4893,172.5322],   // Christchurch NZ
};
