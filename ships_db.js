...
const VESSEL_DB = {
  ...
  '372112000': {
    ...
    history:[
      ...
      'Held station alongside the floating Ship for over a week after Flight 13, rather than returning to the LZ',
      'Escorted the tow after Normand Ranger took Ship 40 under tow ~Aug 2 2026',
      'Dampier was abandoned as a destination mid-August — rough seas set the tow away from the mainland, and the flotilla diverted to Christmas Island instead',
    ],
    notes:'Chartered Panama-flagged PSV, Starship Indian Ocean LZ support. Took part in the Ship 40 (Flight 13) at-sea recovery, Jul–Aug 2026, which ended at Christmas Island rather than the Australian mainland. IMO 9725756, callsign 3FUE8. [✓ MMSI confirmed]',
  },
  '257587000': {
    ...
    history:[
      ...
      'Rigged a tow to Ship 40 and took it under tow ~Aug 2 2026 — the first Starship ever taken under tow',
      'Tow lines made fast to Ship 40\'s nose section; made ~1-1.5 kn against an unfavourable set',
      'Broadcast AIS navigational status "restricted manoeuvrability", consistent with a vessel constrained by a tow',
      'Mid-August 2026: had lost ground rather than closing Dampier, working NE near Christmas Island',
      'Dampier was given up and Christmas Island made the destination — the tow reached it Aug 18 2026, 24 days after launch, completing a ~3-week tow',
    ],
    notes:'Solstad AHTS, 280t bollard pull. Tow vessel for the Ship 40 (Flight 13) recovery, Jul–Aug 2026 — delivered the vehicle to Christmas Island on Aug 18 after the Australian mainland proved unreachable. The bollard pull was never the problem; rigging a bridle to a hull with no designed tow points was. IMO 9413432.',
  },
  '257084000': {
    ...
    history:[
      ...
      'Supported the tow from ~Aug 2 2026 through the diversion to Christmas Island, reached Aug 18 2026',
    ],
    notes:'Support vessel for the Ship 40 (Flight 13) recovery, Jul–Aug 2026, alongside Go Australis and Normand Ranger. Ex-Normand Skimmer. IMO 9609988, callsign LANX7.',
  },
  '636023240': {
    ...
    history:[
      ...
      'Reported inbound toward Dampier during the Ship 40 recovery attempt, August 2026 — never confirmed to have loaded the vehicle',
      'Did not carry Ship 40: the lift went to the semi-submersible FORTE at Christmas Island on Aug 26 2026. Retained here as a resolved lead, not an active recovery asset',
    ],
    notes:'Heavy load carrier reported heading toward the Ship 40 operation in August 2026, but FORTE performed the actual lift. Superseded lead. IMO 9481788, callsign 5LMS4. [MMSI 636023240 — Liberia-flagged; some databases still list a stale 441xxxxxx Korean MMSI]',
  },
  '249364000': {
    name:'Forte', abbr:'Forte',
    operator:'Boskalis', role:'Heavy Transport Carrier (Starship Recovery)',
    color:'#00d4ff', homePort:'Flying Fish Cove, Christmas Island',
    imo:'9592848', flag:'Malta', built:2012, verified:true,
    specs:{ length:'216m', beam:'43m', type:'Semi-Submersible Heavy Transport Vessel (DP-2)', deadweight:'48,312 t' },
    history:[
      'Boskalis semi-submersible heavy transport vessel; registered owner Fairstar Forte BV, commercially managed by Boskalis Offshore Heavy Marine',
      'Took the Ship 40 (Flight 13) load after the tow reached Christmas Island — the ship Dongbang Giant No.2 was wrongly expected to take',
      'Submerged and lifted Ship 40 out of the water at Flying Fish Cove on Aug 26 2026, 33 days after launch — the first Starship ever recovered from the sea',
      'Sailed for the Port of Brownsville, Texas with Ship 40 aboard; ETA Oct 8 2026, making ~14.6 kn as of Aug 29 2026',
    ],
    notes:'Semi-submersible heavy transport vessel that performed the actual Ship 40 lift at Christmas Island on Aug 26 2026 and is carrying the vehicle to Brownsville for Starbase. Not in VesselAPI as of Aug 29 2026 — position is hand-entered via scripts/add-fix.js. IMO 9592848, MMSI 249364000.',
  },
  // ── ULA ──────────────────────────────────────────────────────
  '338731000': {
