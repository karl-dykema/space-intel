...
const VESSEL_DB = {
  ...
  '257587000': {
    ...
    notes:'ACTIVE RECOVERY MISSION — tow vessel for the Ship 40 at-sea recovery, working alongside Go Australis. The bollard pull is ample; the hard part is rigging a bridle to a hull with no designed tow points. Solstad AHTS, IMO 9413432.',
  },
  '257084000': {
    ...
    history:[
      ...
      'Believed to be carrying the rigging crew that must attach a tow bridle to Ship 40',
    ],
